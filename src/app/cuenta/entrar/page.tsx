...
export const metadata = { title: "Entrar — Dos&Go" };
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm rounded-2xl border border-white/10 p-7 shadow-2xl" style={{ background: "linear-gradient(180deg,#15151c,#0c0c11)" }}>
        ...
        <h1 className="font-display text-2xl font-bold text-white mt-1 mb-1.5">Bienvenido de nuevo</h1>
        <p className="text-sm text-gray-400 mb-5">Entra para ver tus pedidos, tu nivel y tus descuentos.</p>
        <AuthForm mode="login" />
      </div>
    </div>
  );
